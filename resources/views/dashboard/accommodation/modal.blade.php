                        ...
                        <div class="modal-body">
                            ...
                            <select name="type" id="" class="form-select mb-2">
                                ...
                                @forelse ($type as $data)
                                    ...
                                    @empty
                                    <option value="" disabled>empty type data</option>
                                @endforelse
                            </select>

                            <input type="number" name="guest" class="form-control mb-2" placeholder="Guest" >
                            <input type="number" name="height" class="form-control mb-2" placeholder="Height" >
